...
## Rich Text Editing with <span className="font-mono bg-secondary -mt-1 border rounded-md p-1 text-[1.2rem]">TipTap</span>
...
Ready to integrate this into your own project? Check out our [setup guide](/blog/remark-setup) to get started!
