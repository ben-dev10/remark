...
<section id="setup-section">
    <div className="fd-steps [&_h3]:fd-step">
          ...
          <div className="ml-8">
            - \#1, \#2 is generated automatically when you run `npx convex dev`
            - \#3,\#4 come from your Clerk dashboard. Follow the official docs <Link href="" className="text-primary underline">here</Link>
